package com.mygdx.starfishcollectorch06;
...
//            return;
        ...
        for (BaseActor rockActor : BaseActor.getList(mainStage, "com.mygdx.starfishcollectorch06.Rock"))
            turtle.preventOverlap(rockActor);

        for (BaseActor starfishActor : BaseActor.getList(mainStage, "com.mygdx.starfishcollectorch06.Starfish")) {
        ...
        if (BaseActor.getList(mainStage, "com.mygdx.starfishcollectorch06.Starfish").size() == 0 && !win) {
            win = true;
            turtle.stop();
        ...
        for (BaseActor sharkActor : BaseActor.getList(mainStage, "com.mygdx.starfishcollectorch06.Shark")) {
        ...
        starfishLabel.setText("Starfish Left: " + BaseActor.getList(mainStage, "com.mygdx.starfishcollectorch06.Starfish").size());
    }
}
